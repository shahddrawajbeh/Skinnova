...
const TYPE_LINKS = {
  new_order: "/store-owner/orders",
  order_status_changed: "/store-owner/orders",
  order_confirmed_received: "/store-owner/orders",
  review_submitted: "/store-owner/reviews",
  review_pending: "/store-owner/reviews",
  post_like: "/store-owner/community",
  post_comment: "/store-owner/community",
  store_new_follower: "/store-owner/store-profile",
};
