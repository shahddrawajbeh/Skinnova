...
const TITLES = {
  ...
  "/store-owner/products": "Products",
  "/store-owner/orders": "Orders",
  "/store-owner/analytics": "Analytics",
  "/store-owner/reviews": "Reviews",
  "/store-owner/community": "Community",
  "/store-owner/store-profile": "Store Profile",
  "/store-owner/notifications": "Notifications",
  "/store-owner/settings": "Settings",
};

function resolveTitle(pathname) {
  if (TITLES[pathname]) return TITLES[pathname];
  if (pathname.startsWith("/store-owner/orders/")) return "Order Details";
  return "Store Owner";
}
